...
const PasswordReset = ({params}: Props) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
        const response = await axios.put('https://api.nevtis.com/user/auth/reset-password', {
            token: params.token,
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-slate-300">
      <form className="w-full max-w-sm bg-orange-100 shadow-lg rounded-md px-8 pt-6 pb-8 mb-4" onSubmit={handleSubmit}>
        ...
        <h2 className="mb-4 text-center text-orange-900 font-semibold text-md">please reset your password</h2>
        <div className="mb-4">
...
{/*           <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="confirmPassword">
          ...
          <input className="shadow appearance-none border rounded w-full mt-2 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
            type="password" 
