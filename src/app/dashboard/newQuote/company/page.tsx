...
export default function CompanyPage() {
  return (
    <div className="w-[83.5vw] h-[100%] p-2">
      <h2 className="text-xl md:text-3xl text-orange-900 text-center">Create your company account </h2>
      ...
      <p className="text-sm text-center mb-2">Fill out the form to create your company account</p>
        <CompanyForm />
    </div>
  );
}