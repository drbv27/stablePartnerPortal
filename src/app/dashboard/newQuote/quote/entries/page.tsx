...
export default function EntriesPage() {
  ...
  return (
    <div className="w-11/12 pl-1 md:w-full">
      <div className="px-6">
        <h2 className="text-center text-2xl text-orange-900">
          Tell us about the service or product
        </h2>
      ...
      >
        ...
        <div className="grid grid-cols-2 items-baseline mt-2 border-b border-orange-950">
          ...
          <select
            {...register("chargetype", { required: true })}
        ...
        <div className="mt-4 flex flex-col justify-start">
          ...
          <button
            type="button"
            className="bg-orange-500 p-1 rounded-md flex ms-auto mt-1 me-1 mb-1"
            onClick={handleNext}
          >
