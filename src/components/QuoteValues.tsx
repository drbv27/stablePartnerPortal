...
const QuoteValues = () => {
    ...
    const { totalEntrieProducts, removeEntrieProducts } = useTotalEntrieProducts();
    ...
    const handleRemove = (product:any) => {
        const newProducts = totalProducts.filter(item => item.title !== product.title)
        removeProducts(newProducts)
    }
    const handleRemoveEntrie = (product:any) => {
        const newProducts = totalEntrieProducts.filter(item => item.title !== product.title)
        removeEntrieProducts(newProducts)
    }

    return (
        <div  className="w-[85vw] md:w-[28vw]  bg-gray-200  text-slate-800">
            <div>
                <div className='bg-orange-500 text-center text-white font-semibold text-lg'>Quote</div>
                <div className='bg-orange-900 border border-b-2 border-orange-500 text-center text-white font-semibold'>Accounts</div>
                <div></div>
                <div>
                    {totalUsers !==0 &&
                        <div className='flex justify-between'>
                            <div>
                                ...
                                <span> {Users.title} <small className='text-white bg-orange-500 px-1 rounded-lg text-xs'>R</small></span>
                            </div>
                            <div>
                                <span className='text-orange-400'>({totalUsers}) </span>
                                x ${Users.price} 
                            </div>
                        </div>
                    }
                    {totalFax !==0 &&
                        <div className='flex justify-between'>
                            <div>
                                ...
                                <span> {Fax.title} <small className='text-white bg-orange-500 px-1 rounded-lg text-xs'>R</small></span>
                            </div>
                            <div>
                                <span className='text-orange-400'>({totalFax}) </span>
                                    x ${Fax.price} 
                            </div>
                        </div>
                    }
                    {totalConference !==0 &&
                        <div className='flex justify-between'>
                            <div>
                                ...
                                <span> {Conference.title} <small className='text-white bg-orange-500 px-1 rounded-lg text-xs'>R</small></span>
                            </div>
                            <div>
                                <span className='text-orange-400'>({totalConference}) </span>
                                    x ${Conference.price} 
                            </div>
                        </div>
                    }
                    {(portNumbers.length - 2)>0 &&
                        <div className='flex justify-between'>
                            <div>
                                ...
                                <span>Port numbers <small className='text-white bg-orange-500 px-1 rounded-lg text-xs'>R</small></span>
                            </div>
                            <div>
                                <span className='text-orange-400'>({portNumbers.length - 2}) </span>
                                    x $2.00
                            </div>
                        </div>
                    }
                </div>
                <div className='bg-orange-900 border border-b-2 border-orange-500 text-center text-white font-semibold'>MarketPlace</div>
                <div>
                    <div>
                            ...
                            <div key={index} className='flex justify-between'>
                                <div>
                                    ...
                                    <span> 
                                        {product.title} 
                                        {product.recurrent 
                                            ? <small className='text-white bg-orange-500 px-1 rounded-lg text-xs ml-1'>R</small>
                                            : <small className='text-white bg-gray-500 px-1 rounded-lg text-xs ml-1'>OT</small>
                                        }
                                    </span>
                                </div>
                                <div>
                                    <span className='text-orange-400'>({product.total}) </span>
                                    x ${product.price} 
                                </div>
                            </div>
                            ))
                ...
                <div className='bg-orange-900 border border-b-2 border-orange-500 text-center text-white font-semibold'>Phone Numbers</div>
                <div>
                </div>
                <div className='bg-orange-900 border border-b-2 border-orange-500 text-center text-white font-semibold'>Miscellaneous</div>
                <div>
                    <div>
                ...
                <div className='bg-orange-800 text-center text-white font-semibold'>Total charges</div>
