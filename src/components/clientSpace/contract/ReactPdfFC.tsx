...
const ReactPdffc = ({company,totalProducts,totalEntrieProducts,totalUsers,totalFax,totalConference,portNumbers,specialTerms,contract}:any) => {
    ...
    <Document>
        <Page size="LETTER" style={{padding:'2vw'}}>
          ...
          {portNumbers.length > 2 &&
              <View style={{ flexDirection: 'row', borderBottom: '1pt solid black', marginBottom: 5, paddingBottom: 5 }}>
                <Text style={{ width: '50%',fontSize:'10px' }}>{PortNumbers.title}: {portNumbers.map((port:any,index:number)=><Text key={index}>{port}|</Text>)}</Text>
                <Text style={{ width: '16%', textAlign:'center',fontSize:'10px' }}>{portNumbers.length-2}</Text>
                <Text style={{ width: '17%', textAlign:'right',fontSize:'10px' }}>${PortNumbers.price.toFixed(2)}</Text>
                <Text style={{ width: '17%', textAlign:'right',fontSize:'10px' }}>${((portNumbers.length - 2) * PortNumbers.price).toFixed(2)}</Text>
              </View>
          }
          ...
          <View>
            ...
            <View style={{flexDirection:'row',justifyContent:'space-between',marginVertical:'3'}}>
              ...
              <View style={{border:'1pt solid #d3d3d3',width:'80%',paddingTop:'10'}}>
                <Text style={{ paddingHorizontal:'16px',textAlign:'center',fontSize:'12px'}}>{contract.creditCard.fullName}</Text>
              </View>
            </View>
            <View style={{flexDirection:'row',justifyContent:'space-between',marginVertical:'3'}}>
              <Text style={{width:'20%',fontSize:'12px'}}>Business address:</Text>
              <View style={{border:'1pt solid #d3d3d3',width:'80%',paddingTop:'10'}}>
                <Text style={{ paddingHorizontal:'16px',textAlign:'center',fontSize:'12px'}}>{contract.creditCard.businessAddress}</Text>
              </View>
            </View>
            <View style={{flexDirection:'row',justifyContent:'space-between',marginVertical:'3'}}>
              <Text style={{width:'20%',fontSize:'12px'}}>Card Number:</Text>
              <View style={{border:'1pt solid #d3d3d3',width:'80%',paddingTop:'10'}}>
                <Text style={{color:'#251b1b', paddingHorizontal:'16px',textAlign:'center',fontSize:'12px'}}> _ _ _ _ - _ _ _ _ - _ _ _ _ - {contract.creditCard.cardNumber.substring(13,16)}</Text>
              </View>
            </View>
            <View style={{flexDirection:'row',justifyContent:'space-between',marginVertical:'3'}}>
            ...
            <View style={{flexDirection:'row',justifyContent:'space-between'}}>
              ...
              <View style={{border:'1pt solid #d3d3d3',width:'33%',paddingTop:'10'}}>
                <Text style={{color:'#251b1b', paddingHorizontal:'16px',textAlign:'center',fontSize:'12px'}}>{contract.creditCard.expirationYear}</Text>
              </View>
              <View style={{border:'1pt solid #d3d3d3',width:'33%',paddingTop:'10'}}>
        ...
        <Page size="LETTER" style={{padding:'2vw'}}>
          <View>
              ...
              <View style={{flexDirection:'row',justifyContent:'space-between',marginVertical:'3'}}>
                ...
                <View style={{border:'1pt solid #d3d3d3',width:'80%',paddingTop:'10'}}>
                  <Text style={{ paddingHorizontal:'16px',textAlign:'center',fontSize:'12px'}}>{contract.bankTransfer.bankName}</Text>
                </View>
              </View>
              <View style={{flexDirection:'row',justifyContent:'space-between',marginVertical:'3'}}>
                <Text style={{width:'20%',fontSize:'12px'}}>Account Number:</Text>
                <View style={{border:'1pt solid #d3d3d3',width:'80%',paddingTop:'10'}}>
                  <Text style={{ paddingHorizontal:'16px',textAlign:'center',fontSize:'12px'}}>{contract.bankTransfer.accountNumber}</Text>
                </View>
              </View>
              <View style={{flexDirection:'row',justifyContent:'space-between',marginVertical:'3'}}>
                <Text style={{width:'20%',fontSize:'12px'}}>Routing Number:</Text>
                <View style={{border:'1pt solid #d3d3d3',width:'80%',paddingTop:'10'}}>
                  <Text style={{ paddingHorizontal:'16px',textAlign:'center',fontSize:'12px'}}>{contract.bankTransfer.routingNumber}</Text>
                </View>
              </View>
          </View>
      ...
      {contract && contract.billMeLater &&
        <Page size="LETTER" style={{padding:'2vw'}}>
          <View>
              <Text>Bill me later Information</Text>
              <View style={{borderTop: "1pt solid lightgray", marginTop: 10, marginBottom: 10}} />
              <View style={{flexDirection:'row',justifyContent:'space-between',marginVertical:'3'}}>
                <Text style={{width:'20%',fontSize:'12'}}>Invoice Name: </Text>
                <View style={{border:'1pt solid #d3d3d3',width:'80%',paddingTop:'10'}}>
                  <Text style={{ paddingHorizontal:'16px',textAlign:'center',fontSize:'12px'}}> {contract.billMeLater.fullName} </Text>
                </View>
              </View>
              <View style={{flexDirection:'row',justifyContent:'space-between',marginVertical:'3'}}>
                <Text style={{width:'20%',fontSize:'12px'}}>Business Address: </Text>
                <View style={{border:'1pt solid #d3d3d3',width:'80%',paddingTop:'10'}}>
                  <Text style={{ paddingHorizontal:'16px',textAlign:'center',fontSize:'12px'}}> {contract.billMeLater.businessAddress} </Text>
                </View>
              </View>
          </View>
