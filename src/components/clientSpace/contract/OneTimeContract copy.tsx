...
const OneTimeContract = ({data}:any) => {
    ...
    return (
        <div className="w-full border border-gray-300 mt-4 p-1 md:p-4 rounded-md">
            <table className="min-w-full border border-gray-500">
                ...
                <tr>
                    <th colSpan={9} className="px-1 md:px-6 py-1  border border-gray-300 text-center text-base text-gray-600 tracking-wider bg-gray-200">
                        One Time Charges
                    </th>
                </tr>
                </thead>
                ...
                {totalProducts.filter((product:Product) => !product.product.recurrent).map((product:any) => (
                    <tr key={product._id}>
                        ...
                        <td colSpan={2} className="font-normal md:font-semibold md:px-6 py-1 whitespace-no-wrap border border-gray-300 leading-5 text-right">
    ...
    {/*             {promocode !== null && (
                    <tr>
                        <td colSpan={5} className="px-6 py-1 whitespace-no-wrap border border-gray-300 leading-5">
                            <span className='font-semibold text-orange-900'>Discount</span><span className='text-xs'> </span> 
                        </td>
                        <td colSpan={2} className="font-semibold px-6 py-1 whitespace-no-wrap border border-gray-300 leading-5 text-right">
