const QuoteInfo = ({data}:any) => {
  return (
    <div className="my-4 border shadow-md py-2 px-4 rounded-md">
        ...
        <h3 className="flex flex-col md:flex-row"><span className="text-gray-600">Service Address:</span> <span className="text-sm md:ms-1">{`${data.company.address}, ${data.company.city}, ${data.company.state}, ${data.company.zip}`}</span></h3>
        <h3><span className="text-gray-600">Proposal date:</span> </h3>
        <h3><span className="text-gray-600">Valid until:</span> </h3>
