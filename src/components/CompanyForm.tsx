...
const CompanyForm = () => {
  ...
  return (
    <form
      className="w-full border border-gray-300 rounded-xl shadow-xl p-1 py-4 h-[80vh] md:h-[75vh] overflow-y-auto"
    ...
    >
        ...
        <div className="my-1 md:my-2 grow">
          <div className="my-1 w-full relative rounded-2xl shadow-xl">
            ...
            >
              ...
              <option value="Residential" className="text-gray-600">
                Residential
              </option>
            </select>
          </div>
        ...
        <div className="my-1 md:my-2 grow">
          <div className="my-1 w-full relative rounded-2xl shadow-xl">
            ...
            >
              ...
              <option value="Need Quote" className="text-gray-600">
                Need Quote
              </option>
              <option value="CBI" className="text-gray-600">
                CBI
              </option>
              <option value="Fiber" className="text-gray-600">
                Fiber
              </option>
              <option value="DSL" className="text-gray-600">
                DSL
              </option>
            </select>
          </div>
        ...
        <div className="my-1 md:my-2 grow">
          <div className="my-1 w-full relative rounded-2xl shadow-xl">
            ...
            >
              ...
              <option value="HQ" className="text-gray-600">
                HQ
              </option>
              <option value="Branch" className="text-gray-600">
                Branch
              </option>
              <option value="Executive Suite" className="text-gray-600">
                Executive Suite
              </option>
            </select>
          </div>
        ...
        <div className="my-1 md:my-2 grow">
          <div className="my-1 w-full relative rounded-2xl shadow-xl">
            ...
            >
              ...
              <option value="Month to Month" className="text-gray-600">
                Month to Month
              </option>
              <option value="12 Months" className="text-gray-600">
                12 Months
              </option>
              <option value="24 Months" className="text-gray-600">
                24 Months
              </option>
              <option value="36 Months" className="text-gray-600">
                36 Months
              </option>
            </select>
          </div>
      ...
      <button className="bg-orange-500 p-1 rounded-md flex ms-auto me-4 mb-1">
        <span className="text-lg text-gray-200">Save </span>{" "}
