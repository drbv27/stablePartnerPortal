  ...
  return (
    ...
    <div className='px-1 md:px-6 pt-6'>
        <table className="w-full border border-gray-500">
            ...
            {newTotalProducts.filter(product => !product.recurrent).map((product) => (
                <tr key={product.id}>
...
{/*             <tr>
            ...
            <tr>
                ...
                <td colSpan={2} className="font-semibold px-1 md:px-6 py-1 border border-gray-300 bg-orange-200 leading-5">
                    ...
                    {/* ${promocode !== null ? (oneTimeTotal - oneTimeTotal * promocode.discount + oneTimeTotal * 0.0775).toFixed(2) : (oneTimeTotal ).toFixed(2)} */}
...
export default EditedOneTimeCh